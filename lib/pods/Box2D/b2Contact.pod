...
=item * C<Box2D::b2Fixture> C<$fixtureA>

=item * C<Box2D::b2Fixture> C<$fixtureB>
...
=item * C<Box2D::b2ContactCreateFcn> C<$createFcn>

=item * C<Box2D::b2ContactDestroyFcn> C<$destroyFcn>

=item * C<Box2D::b2Shape> C<$typeA>

=item * C<Box2D::b2Shape> C<$typeB>
...
=item * C<Box2D::b2Transform> C<$xfA>

=item * C<Box2D::b2Transform> C<$xfB>
...
=item * C<Box2D::b2WorldManifold> C<$worldManifold>
...
=item *  C<$bool b2Contact::s_initialized = false [static, protected]> (optional)
...
=item *  C<$b2ContactRegister b2Contact::s_registers [static, protected]> (optional)
