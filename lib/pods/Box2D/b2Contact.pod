...
=head2 virtual b2Contact::~b2Contact ()

=head2 virtual b2Contact::~b2Contact ( $virtual b2Contact::~b2Contact  )

Parameters:

=over 4

=item *  $virtual b2Contact::~b2Contact  (optional)
...
=head2 virtual void b2Contact::Evaluate ( $manifold, $xfA, $xfB )
