...
=item * C<Box2D::b2FixtureDef> C<$def>
...
=item * C<Box2D::b2BroadPhase> C<$broadPhase>

=item * C<Box2D::b2Transform> C<$xf>
...
=item *  C<$b2Shape::Type b2Fixture::GetType > (optional)
...
=item * C<Box2D::b2Filter> C<$filter>
...
=item * C<Box2D::b2Transform> C<$xf1>

=item * C<Box2D::b2Transform> C<$xf2>
