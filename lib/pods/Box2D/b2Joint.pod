...
=head2 virtual b2Joint::~b2Joint ( $virtual b2Joint::~b2Joint  )

Parameters:

=over 4

=item *  $virtual b2Joint::~b2Joint  (optional)
...
=head2 virtual b2Vec2 b2Joint::GetAnchorA ( $virtual b2Vec2 b2Joint::GetAnchorA  )
...
=item *  $virtual b2Vec2 b2Joint::GetAnchorA  (optional)

=back

=head2 virtual b2Vec2 b2Joint::GetAnchorB ()

=head2 virtual b2Vec2 b2Joint::GetAnchorB ( $virtual b2Vec2 b2Joint::GetAnchorB  )
...
=item *  $virtual b2Vec2 b2Joint::GetAnchorB  (optional)
