...
=head1 SYNOPSIS
 ...
 my ($a11, $a12, $a21, $a22) = (4, 0, -2, 3);

 # Construct matrix with numbers
 my $matrix = Box2D::b2Matrix->new( $a11, $a12, $a21, $a22 );
 
 my $c1 = Box2D::b2Matrix->new( $a11, $a12 );
 my $c2 = Box2D::b2Matrix->new( $a21, $a22 );
...
stored in column-major order. The L</SYNOPSIS> shows exactly how the matrix is arranged.
...
The L</SYNOPSIS> shows exactly how the matrix is arranged.
