...
=head1 SYNOPSIS
 ...
 my ( $a11, $a21, $a31 ) = (  4,  0,  5 );
 my ( $a12, $a22, $a32 ) = ( -2,  3,  7 );
 my ( $a12, $a22, $a33 ) = (  0, -9, -3 );
 
 my $c1 = Box2D::b2Vec3->new( $a11, $a12, $a13 );
 my $c2 = Box2D::b2Vec3->new( $a21, $a22, $a23 );
 my $c3 = Box2D::b2Vec3->new( $a21, $a22, $a33 );
