...
It actually isn't a constant, because it has to return a new vector object every time.
For this reason, you can use it and modify it at will without worry.
