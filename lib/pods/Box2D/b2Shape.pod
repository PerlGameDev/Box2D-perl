...
=head2 virtual b2Shape::~b2Shape ()

=head2 virtual b2Shape::~b2Shape ( $virtual b2Shape::~b2Shape  )

Parameters:

=over 4

=item *  $virtual b2Shape::~b2Shape  (optional)
...
=head2 virtual void b2Shape::ComputeAABB ( $aabb, $xf )
...
=head2 virtual void b2Shape::ComputeMass ( $massData, $density )
...
=head2 virtual bool b2Shape::RayCast ( $output, $input, $transform )
...
=head2 virtual bool b2Shape::TestPoint ( $xf, $p )
