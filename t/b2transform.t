...
cmp_ok( abs($transform->q->GetAngle() - $angle), "<=", 1e-5, "angle" );
...
cmp_ok( abs($transform->q->GetAngle() - $angle2), "<=", 1e-5, "Set angle" );
...
cmp_ok( abs($transform->q->GetAngle() - $angle2), "<=", 1e-5, "Set q" );
